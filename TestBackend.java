...
public class TestBackend {
		...
		if (this.testAddGenre()) {
		        ...
		        System.out.println("Test add genres: FAILED");
		}
		if (this.testAddAvgRating()) {
		        System.out.println("Test add average rating: PASSED");
		} else {
    ...
    /**
     * This test instantiates the back end with three movies and attempts to add a genre to categorize movies by.
     * It passes when the array of genres contains the genre passed in and fails otherwise
     * @return true if the test passed, false if it failed
     **/
    ...
    /**
     * This test instantiates the back end with three movies and attempts to add a rating to categorize movies by.
     * It passes when the array of ratings contains the genre passed in and fails otherwise
     * @return true if the test passed, false if it failed
     **/
	...
	try {
			...
			if(backendToTest.getAvgRatings().contains("6")){
				//passed
				return true;
			} 
			else {
    ...
    public boolean testThreeMovies() {
    	// instantiate once BackendInterface is implemented
	try {
			BackendInterface backendToTest =  new Backend(new StringReader(
					"title,original_title,year,genre,duration,country,language,director,writer,production_company,actors,description,avg_vote\n"
